...
export default class Header extends ShopOptions {
    constructor(getFromLocalStorage) {
        super(getFromLocalStorage)
    }
    render(){
        const header = `
                ...
                <div class="container">
                    <div class="header">
                        ...
                        <a href="index.html" class="logo">
                            <img src="./assets/image/ikea-logo.svg" alt="Логотип">
                        </a>
                        ...
                        ${Number(this.getFromLocalStorage('sumCartList')) ? 
                        `<span id="sumCartList">${this.getFromLocalStorage('sumCartList')}</span>`:
                        ''}
